...
<div className='flex flex-col justify-center items-center'>
 {/*  Image  */}
 <div>
 <Image src={require('../../../public/images/home/Granite square side table 1.png')} alt='product Img' width={564} height={383}/>
 </div>
 {/* left side text */}
...
<div className='flex flex-col justify-center items-center'>
   ...
   {/* right Image  */}
 <div>
 <Image src={require('../../../public/images/home/Cloud sofa three seater + ottoman_3 1.png')} alt='product Img' width={564} height={383}/>
 </div>
     {/* right side text 02 */}
